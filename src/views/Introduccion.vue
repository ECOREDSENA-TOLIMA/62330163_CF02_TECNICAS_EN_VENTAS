  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      .col-12.col-md-10.col-lg-10(data-aos="fade-up")
        ...
        figure.mb-5
          img.d-none.d-sm-none.d-lg-block(src='@/assets/curso/temas/introduccion/img-02-01.svg', alt='Figura 1. Comparte una serie de conceptos relacionados con el cierre de la negociación en cuatro conceptos, el primero es el de técnicas de cierre de ventas, seguido por la relación de los clientes a través de una red, enseguida está el apoyo que la técnica psicocibernética puede dar y se cierra con el concepto de la garantía y el servicio posventa como aliado fundamental en la fidelización.')
          img.d-block.d-lg-none(src='@/assets/curso/temas/introduccion/img-02-02.svg', alt='Figura 1. Comparte una serie de conceptos relacionados con el cierre de la negociación en cuatro conceptos, el primero es el de técnicas de cierre de ventas, seguido por la relación de los clientes a través de una red, enseguida está el apoyo que la técnica psicocibernética puede dar y se cierra con el concepto de la garantía y el servicio posventa como aliado fundamental en la fidelización.') 

    figure.mb-5(data-aos="zoom-in")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/G8YKyjkvezI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
